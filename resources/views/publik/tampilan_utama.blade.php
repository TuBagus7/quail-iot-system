        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <span
                        class="text-xl font-bold bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">QuailYes
                        IoT</span>
                </div>
                ...
                <div class="flex items-center space-x-4 md:space-x-6">
                    <!-- WiFi Status -->
                    <div
                        class="flex items-center space-x-2 bg-slate-700/50 px-3 py-1.5 rounded-full border border-slate-600/50">
                    ...
                    @auth
                        <div class="flex items-center space-x-3">
                            <span
                                class="text-xs font-mono text-emerald-400 bg-emerald-500/10 px-2 py-1 rounded border border-emerald-500/20">ADMIN
                                ACTIVE</span>
                            <a href="{{ route('admin.dashboard') }}"
                                class="p-2 bg-slate-700 hover:bg-slate-600 rounded-lg text-white transition-all shadow-lg"
                            ...
                            <form action="{{ route('keluar') }}" method="POST" class="inline">
                                @csrf
                                <button type="submit"
                                    class="p-2 bg-red-500/10 hover:bg-red-500/20 text-red-500 rounded-lg transition-all border border-red-500/20"
                                    title="Keluar">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    @else
                        <a href="{{ route('masuk') }}"
                            class="group flex items-center space-x-2 bg-emerald-500 hover:bg-emerald-400 px-4 py-2 rounded-xl transition-all shadow-lg shadow-emerald-500/20">
                            <svg class="w-4 h-4 text-white group-hover:rotate-12 transition-transform" fill="none"
    ...
    <div class="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
        ...
        <header class="mb-10 text-center">
            <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight mb-2">
                <span class="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">Monitoring
                    Kandang</span>
            </h1>
            <p class="text-slate-400 max-w-2xl mx-auto flex items-center justify-center gap-2">
                Real-time data stream via <span
                    class="px-2 py-0.5 bg-emerald-500/10 text-emerald-400 rounded-md border border-emerald-500/20 font-mono text-sm">MQTT
                    Broker</span>
            </p>
        </header>
        ...
        <main>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                <!-- Gauge 1: Suhu -->
                <div
                    class="bg-slate-800 p-6 rounded-2xl border border-slate-700 shadow-xl flex flex-col items-center hover:scale-[1.02] transition-transform">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                <!-- Status & Info Card -->
                <div
                    class="bg-slate-800 p-8 rounded-3xl border border-slate-700 shadow-2xl relative overflow-hidden group">
                    ...
                    <div
                        class="flex items-center justify-center min-h-[120px] bg-slate-900/50 rounded-2xl border border-slate-700/50 p-6">
                ...
                <div
                    ...
                    <div class="flex flex-col items-center justify-center space-y-6 min-h-[120px]">
                        <label class="relative inline-flex items-center cursor-pointer scale-125">
                            ...
                            <div
                                class="w-14 h-7 bg-slate-600 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all peer-checked:bg-emerald-500">
                            </div>
                            <span class="ml-3 text-lg font-medium text-slate-300">Mute Buzzer</span>
                        </label>
                        <p class="text-xs text-slate-500 uppercase tracking-widest font-bold">Aktifkan untuk mematikan
                            suara alarm</p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                <div class="text-slate-400 text-sm">
                    &copy; {{ date('Y') }} <span class="font-bold text-emerald-400">QuailYes IoT</span> - Monitoring
                    Kandang Puyuh Pintar
                </div>
